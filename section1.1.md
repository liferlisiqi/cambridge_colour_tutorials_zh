...
![Cavity Array](https://liferlisiqi.github.io/cambridge_colour_tutorials_zh/jpg/1.1_cavity_array.png)
...
![bayer Array](https://liferlisiqi.github.io/cambridge_colour_tutorials_zh/jpg/1.1_bayer_array.png)
...
![origin & bayer](https://liferlisiqi.github.io/cambridge_colour_tutorials_zh/jpg/1.1_bayer&origin.png)

## Bayer demosaicing

去马赛克（demosaicing）是将Bayer图转换成每个像素都包含三原色的图像的过程，如果相机不能直接测量全部色彩，那么这个过程是如何实现的呢？如果我们将每四个2x2的光腔阵列想象成一个单独的全颜色光腔，就可以解决这个问题。

![demosaic](https://liferlisiqi.github.io/cambridge_colour_tutorials_zh/jpg/1.1_demosaic.png)
...
![demosaic2](https://liferlisiqi.github.io/cambridge_colour_tutorials_zh/jpg/1.1_demosaic2.png)
...
![demosaic_artifact](https://liferlisiqi.github.io/cambridge_colour_tutorials_zh/jpg/1.1_demosaic_artifact.png)
...
![microlens](https://liferlisiqi.github.io/cambridge_colour_tutorials_zh/jpg/1.1_microlens.png)
